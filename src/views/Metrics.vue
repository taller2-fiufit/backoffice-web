                ...
                <v-col cols="6">
                  <v-row>
                    <v-col cols="12" class="my-0 py-0">
                      ...
                      <v-space></v-space>
                      <v-card-text>Usuarios utilizando mail y contraseña</v-card-text>
                      <v-card-text>Usuarios utilizando identidad federada</v-card-text>
                    </v-col>
                  </v-row>
                </v-col>
                ...
                <v-col cols="6">
                  <v-row>
                    <v-col cols="12" class="my-0 py-0">
                      ...
                      <v-space></v-space>
                      <v-card-text>Usuarios bloqueados</v-card-text>
                    </v-col>
                  </v-row>
                </v-col>
              </v-row>
